...
public class ProductDetailUI {
	...
	public static final String PRODUCT_RATING_CHECKBOX = "//input[@id='addproductrating_4']";
	public static final String ADD_REVIEW_BUTTON = "//button[@name='add-review']";
	public static final String REVIEW_SUCCESS_MESSAGE = "//div[@class='result']";
