...
public class BasePage {
	...
	public DownloadableProductPageObject openDownloadProductPage(WebDriver driver) {
	...
	public BackInStockSubscriptionsPageObject openBackInStockSubscriptionPage(WebDriver driver) {
