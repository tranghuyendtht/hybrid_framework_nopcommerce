package com.nopcommerce.user.cloud;
...
public class Level_16_Live_Coding_Lambda extends BaseTest {
	...
	public void beforeClass(String browserName, String appUrl, String osName, String osVersion) {
		driver = getBrowserDriverLambda(browserName, appUrl, osName, osVersion);
